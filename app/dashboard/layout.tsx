...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-40 transform transition-all duration-500 ease-in-out md:translate-x-0 w-[80%] max-w-[300px] md:w-auto", // FIXED: Better width for mobile
